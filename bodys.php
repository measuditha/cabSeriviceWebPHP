    ...
    <section class="container-fluid box col-lg-4 col-sm-10 col-xs-12 col-md-7 ml-lg-5 ml-md-5 pt-lg-4 mt-lg-4 pt-sm-0 mt-sm-0 mb-5 pb-3 pt-2">
      <div class="text-center">
        ...
        <form action="body.php" method="post">
          ...
          <div class="form-group  row feilds ">
            ...
            <select  class="form-control-plaintext col-sm-9 arro" id="cabtype">
              ...
              <option value="GoCheetaMicro" <?php if(isset($c)){ if($c== 'GoCheetaMicro') { ?>selected<?php } }?>>GoCheetaMicro</option>
              <option value="GoCheetaMini" <?php if(isset($c)){ if($c== 'GoCheetaMini') { ?>selected<?php } }?>>GoCheetaMini</option>
              <option value="GoCheetaRoyal" <?php if(isset($c)){ if($c== 'GoCheetaRoyal') { ?>selected<?php } }?>>GoCheetaRoyal</option>
              <option value="GoCheetaSUV" <?php if(isset($c)){ if($c== 'GoCheetaSUV') { ?>selected<?php } }?>>GoCheetaSUV</option>
            </select>
        </div>
        ...
        <div class="form-group  row feilds ">
          ...
          <p id="err" class="text-danger h6">*Luggage is not available in GoCheetaMicro</p>
        </div>
