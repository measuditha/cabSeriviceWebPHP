        ...
        <div class="card bg-success text-center">
          ...
          <i class="fas fa-taxi po"></i>
            ...
            <p class="card-text font-weight-bold text-dark h1">
              ...
              $adm = new user();
            $admc = new dbcon();
            $cn = $adm->countride($id,$admc->connect());
            print_r($cn); ?></p>
      ...
      <div class="col-sm-6 col-lg-3 ">
        <div class="card bg-warning text-center">
          ...
          <i class="fas fa-car po"></i>
            ...
            <p class="card-text font-weight-bold text-dark h1">
              <?php
            $cn = $adm->pcountride($id,$admc->connect());
            print_r($cn); ?></p>           
      ...
      <div class="col-sm-6 col-lg-3 ">
        <div class="card bg-info text-center">
          ...
          <i class="fas fa-check po"></i>
            ...
            <p class="card-text font-weight-bold text-dark h1">
              <?php
            $cn = $adm->cocountride($id,$admc->connect());
            print_r($cn); ?></p>   
    ...
    <div class="col-sm-6 col-lg-3 ">
        <div class="card bg-success text-center">
          ...
          <i class="fas fa-times po"></i>
            ...
            <p class="card-text font-weight-bold text-dark h1">
              <?php
            $cn = $adm->cacountride($id,$admc->connect());
            print_r($cn); ?></p>
      ...
      <div class="col-sm-6 col-lg-3 ">
        <div class="card bg-warning text-center">
          <div class="card-body">
          <i style="color:black; font-size:400%; font-family:Noto Serif; color:#131313;">LKR</i>
