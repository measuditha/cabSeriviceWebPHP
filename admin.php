      ...
      <div class="col-sm-6 col-lg-3 ">
        <div class="card bg-warning text-center">
          <div class="card-body">
            ...
            <p class="card-text font-weight-bold text-dark h1">
              <?php
            $cn = $adm->pcountride($admc->connect());
            print_r($cn); ?></p>           
      ...
      <div class="col-sm-6 col-lg-3 ">
        <div class="card bg-info text-center">
          <div class="card-body">
            ...
            <p class="card-text font-weight-bold text-dark h1">
              <?php
            $cn = $adm->cocountride($admc->connect());
            print_r($cn); ?></p>   
    ...
    <div class="col-sm-6 col-lg-3 ">
        <div class="card bg-success text-center">
          <div class="card-body">
            ...
            <p class="card-text font-weight-bold text-dark h1">
              <?php
            $cn = $adm->cacountride($admc->connect());
            print_r($cn); ?></p>
    ...
    <div class="col-sm-6 col-lg-3 ">
        <div class="card bg-success text-center">
          <div class="card-body">
            ...
            <p class="card-text font-weight-bold text-dark h1">
              <?php
            $au = $adm->acountuser($admc->connect());
            print_r($au); ?></p>
      ...
      <div class="col-sm-6 col-lg-3 ">
        <div class="card bg-warning text-center">
          <div class="card-body">
            ...
            <p class="card-text font-weight-bold text-dark h1">
            <?php 
            $pu = $adm->pcountuser($admc->connect());
             echo $pu; ?></p>
