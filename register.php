<?php
  ...
  if(isset($_SESSION['userdata'])){
    ...
    $user = new user();
		$dbcon = new dbcon();
		$show=$user->register($username,$password,$password2,$email,$mobile,$datetime,$dbcon->connect());
...
<body>
    ...
    <h1 class="text-center mt-lg-5 pt-lg-5 mt-sm-0 pt-sm-0 font-weight-bold">Go<span class="gree">Cheeta</span></h1>
